...
namespace Strings {
    ...
    const std::string DB_DELETE_SAVED_ARTICLE_SUCCESS = "Article {} has been successfully deleted for user {}.\n";
    ...
    const std::string DB_ARTICLE_INSERTED_LINE = " (at line {}\n";
    ...
    // Adapters
    const std::string ADAPTER_THENEWSAPI_KEY = "E02tf7DTesEzIvEVbtezYUADgbAn4WQd9EWXrKXY";
    ...
    const std::string ADAPTER_THENEWSAPI_SOURCE_NAME = "thenewsapi.com";
    
    const std::string ADAPTER_NEWSAPIORG_KEY = "cf2275c8dedd4fef9c4b5c49d2bd09bb";
